  ...
  return (
    <div className="">
      <div style={{ position: "relative", zIndex: -1 }}>
        <ReactPlayer
          url="https://www.youtube.com/watch?v=zkCKx3fpk4Q&t=29"
          playing
          loop
          muted
          width="1920px"
      ...
      <div
        style={{
          ...
          height: "100%",
          background:
            "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 50%, rgba(0,0,0,0.3) 75%, rgba(0,0,0,1) 90%)",
          zIndex: 1,
        }}
      />
      <div
          ...
          <div className="min-h-screen pt-60 p-20">
            <div className="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
              ...
              <p className="text-3xl pt-12 text-gray-100 mb-10">
                A vast and intricate collection of celestial bodies centered
                around the Sun.
              </p>
            </div>

            <button
              className="uppercase py-2 mt-8 px-4 rounded-lg bg-cyan-500 border-2 border-transparent text-white text-2xl mr-4 hover:bg-cyan-400 hover:text-black"
