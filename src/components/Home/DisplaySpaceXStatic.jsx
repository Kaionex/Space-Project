...
const DisplaySpaceXStatic = ({ setShowModal, showModal }) => {
  ...
  useEffect(() => {
    ...
    const performSearch = async () => {
      try {
        ...
        const url = `https://images-api.nasa.gov/search?q=spaceX`;
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col items-center justify-center text-white">
      <div>
      <h2 className="mt-0 px-10 pb-2 pt-20 text-center bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500 text-5xl font-bold tracking-tight text-transparent md:text-5xl">
          SpaceX Today
        </h2>
        <h3 className="text-center text-white text-base md:text-2xl font-normal max-w-5xl pb-4 mx-auto">
          Latest news, images and videos from SpaceX
        </h3>
      </div>
...
export default DisplaySpaceXStatic;
